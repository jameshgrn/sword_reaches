...
df = df.dropna(subset=['ridge1_dist_along', 'ridge2_dist_along', 'floodplain1_dist_along', 'floodplain2_dist_along', 'channel_dist_along'])

# Assuming 'df' is your DataFrame containing all the data
X = df.drop(['channel_dist_along', 'ridge1_dist_along', 'ridge2_dist_along', 'floodplain1_dist_along', 'floodplain2_dist_along'], axis=1)  # Drop non-feature columns
