...
plt.scatter(df['ridge_width_mean'], df['ridge_height_mean'], c='b', label='Ridge Mean')
plt.xscale('log')
plt.yscale('log')
...
plt.plot(np.exp(df_ols['log_ridge_width_mean']), np.exp(results.fittedvalues), 'r', label='OLS Fit')
