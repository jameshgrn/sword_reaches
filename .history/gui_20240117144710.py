...
def compute_attributes(df, labeled_points):
    ...
    df['slope_'].iloc[0] = df['elevation'].iloc[1] - df['elevation'].iloc[0]
    ...
    # Extract attributes
    position_dependent_attrs = ['elevation', 'slope', 'curvature', 'dist_along', 'dist_to_river_center']
...
# Define n
n = 500  # adjust this value to skip cross sections
labeled_data = []
