...
ridge1_slope = selected_rows1.apply(lambda row: (row['ridge1_elevation'] - row['floodplain1_elevation']) / abs(row['ridge1_dist_al'] - row['floodplain1_along_track_distance']), axis=1)
