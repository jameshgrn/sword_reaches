...
# Clean data with z-score
df['ridge_height_mean'] = (df['ridge_height_mean'] - df['ridge_height_mean'].mean()) / df['ridge_height_mean'].std()
df['ridge_width_mean'] = (df['ridge_width_mean'] - df['ridge_width_mean'].mean()) / df['ridge_width_mean'].std()
...
plt.xlabel('Mean Ridge Width (standardized)')
plt.ylabel('Mean Ridge Height (standardized)')
