...
df_copy = df_copy[(np.abs(stats.zscore(df_copy[['ridge_height_mean', 'ridge_width_mean']])) < 3).all(axis=1)]

# Scatter plot for mean ridge height vs mean ridge width
plt.figure(figsize=(10, 5))
plt.scatter(df_copy['ridge_width_mean'], df_copy['ridge_height_mean'], c='purple', label='Ridge Mean')
