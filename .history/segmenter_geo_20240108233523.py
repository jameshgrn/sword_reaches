...
cross_section_points = perform_geometric_operations(node_gdf, 0.5, 1.5, )
...
cross_section_stats.to_parquet('cross_section_stats_test.parquet')
#%%
# Plotting
