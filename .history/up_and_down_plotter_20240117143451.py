...
ridge2_slope = selected_rows2.apply(lambda row: (row['ridge2_elevation'] - row['floodplain2_elevation']) / abs(row['ridge2_dist_a'] - row['floodplain2_along_track_distance']), axis=1)
