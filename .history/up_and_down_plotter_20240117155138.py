...
# Ensure that you only take the log of positive values
df = df[(df['ridge_height_mean'] > 0) & (df['ridge_width_mean'] > 0)]
...
plt.title('Mean Ridge Width vs Log of Mean Ridge Height')
plt.legend()
plt.tight_layout()
plt.show()
# %%
