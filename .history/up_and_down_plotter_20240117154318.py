...
# %%
# Scatter plot for ridge1 height vs width
plt.figure(figsize=(10, 5))
plt.scatter(df['ridge1_width'], df['ridge1_height'], c='blue', label='Ridge 1')
plt.xlabel('Ridge Width (m)')
plt.ylabel('Ridge Height (m)')
plt.title('Ridge 1 Width vs Height')
plt.legend()
plt.show()

# Scatter plot for ridge2 height vs width
plt.figure(figsize=(10, 5))
plt.scatter(df['ridge2_width'], df['ridge2_height'], c='red', label='Ridge 2')
plt.xlabel('Ridge Width (m)')
plt.ylabel('Ridge Height (m)')
plt.title('Ridge 2 Width vs Height')
plt.legend()
plt.show()