...
ridge1_slope = selected_rows1.apply(lambda row: (row['ridge1_elevation'] - row['floodplain1_elevation']) / abs(row['ridge1_dist_along'] - row['floodplain1_along_track_distance']), axis=1)
...
ridge2_slope = selected_rows2.apply(lambda row: (row['ridge2_elevation'] - row['floodplain2_elevation']) / abs(row['ridge2_dist_along'] - row['floodplain2_along_track_distance']), axis=1)
