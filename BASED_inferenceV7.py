...
V7 = pd.read_csv('data/V7_output.csv')
dicharge_rid = {61562000801:19.915, 61562000791: 25.417, 61562000781: 28.146,
...
V7 = V7.merge(discharge_series, on='reach_id', how='left').dropna()
...
V7['XGB_depth'] = xgb_reg.predict(guesswork)
V7['XGB_depth'] = V7['XGB_depth'].clip(lower=0)
df = V7
